...
$\bullet$ Experience in area of consumer electronics, industrial robotics and self-driving technology. \newline
$\bullet$ Helped to solve HW and SW problems for outsourcing, start-up and corporate companies.
% $\bullet$ Main focus on Linux and RTOS apps, device drivers, high-level and system SW.
\end{rSection}

\begin{rSection}{skills}
\begin{tabular}{llll}
$\bullet$ \textbf{Languages:}  & plain C, C++17, Python, Bash    & $\bullet$ \textbf{Build systems:} & make, CMake, Bazel \\
$\bullet$ \textbf{Dev tools:}  & Git, Docker, CI, issue trackers & $\bullet$ \textbf{Embedded:}      & boards bring-up, lab equipment   \\
$\bullet$ \textbf{Frameworks:} & Boost, ROS, POCO, Anaconda \\
$\bullet$ \textbf{Basic math:} & linear algebra, calculus, statistics
\end{tabular}
\end{rSection}
...
\end{rCompany}
\begin{rCompany}{\href{https://www.tra.ai}{Arrival Robotics}}{June 2017 -- October 2019}{Lead Software Engineer (full-time)}{Saint Petersburg, Russian Federation}
...
{\bf \href{https://www.dvfu.ru/en/}{Far Eastern Federal University}} \hfill {2005 -- 2010} \newline
...
1-Wire, ADC, Ansible, Atomthreads, AVR, avr-gcc, BAT, Bash, Berkeley sockets, Boost, BSP, Buildroot, C, C++, CAF, ccache, CMake,
