...
\address{
    \Mobilefone \ +7$\cdot$924$\cdot$320$\cdot$0934 \textbar \
...
\item Solving of time critical project issues under a customer's pressure. Resolved a number of various \textquote{MP block} software and hardware
...
\item Prototype of the \textquote{Power over Ethernet} injector design and manufacturing. Physical layer of the IEEE
