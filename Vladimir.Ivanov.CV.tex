...
\address{\em Moscow, Russian Federation}

\begin{document}

\begin{rSection}{summary}

Proficient engineer with a focus on the EECS. Visited electronics factories as board bring-up engineer for imaging products market.
Helped industrial robotic startup on the early stages of company formation. Contributed to self-driving car technologies.
Main areas of interest: consumer electronics, industrial and mobile robotics, automotive industry, high quality products,
cyber-physical systems, disruptive technologies.

\end{rSection}

\begin{rSection}{experience}
\begin{rCompany}{\href{https://taxi.yandex.com/company}{Yandex Taxi}}{October 2019 -- present}{Software Engineer (full-time)}{Moscow, Russian Federation}

\item Self-driving cars department, embedded systems development group.

\end{rCompany}
\begin{rCompany}{\href{https://www.tra.ai}{TRA Robotics}}{June 2017 -- October 2019}{Lead Software Engineer (full-time)}{Saint Petersburg, Russian Federation}
